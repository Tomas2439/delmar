  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        {/* Main grid */}
        <div
          style={{ display: "grid", gridTemplateColumns: "1fr auto 1fr", gap: 48, alignItems: "start", marginBottom: 52 }}
        ...
        >
          ...
          <div>
            ...
            <div style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "rgba(255,255,255,0.35)", fontFamily: "'Inter', sans-serif", fontSize: "0.83rem" }}>
              <MapPin size={13} style={{ color: "#E6007E" }} />
          ...
          <div style={{ textAlign: "right" }} className="footer-right">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12, alignItems: "flex-end" }}>
              ...
              <a
                ...
                style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "#25D366", fontFamily: "'Poppins', sans-serif", fontWeight: 600, fontSize: "0.88rem", textDecoration: "none", transition: "opacity 0.2s" }}
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                style={{ display: "inline-flex", alignItems: "center", gap: 8, color: "#FF6FB5", fontFamily: "'Poppins', sans-serif", fontWeight: 600, fontSize: "0.88rem", textDecoration: "none", transition: "opacity 0.2s" }}
                onMouseEnter={(e) => ((e.currentTarget as HTMLAnchorElement).style.opacity = "0.7")}
                onMouseLeave={(e) => ((e.currentTarget as HTMLAnchorElement).style.opacity = "1")}
              >
              ...
              <a
                id="footer-catalogo"
                href="https://drive.google.com/drive/folders/1dT4CR1_MviPWuiADV4AGogNiy5genW2D?usp=sharing"
        ...
        {/* Divider */}
        <div style={{ height: 1, background: "linear-gradient(90deg, transparent, rgba(230,0,126,0.25), transparent)", marginBottom: 24 }} />
